...
Este capítulo apresenta a metodologia adotada neste trabalho. Ele está organizado em cinco etapas. \comentline{Citar cada uma das cinco etapas}
...
\begin{itemize}
    ...
    \item possuir \st{ampla} documentação em trabalhos de poda neural;
    \item \modificado{contar com implementação acessível em \textit{frameworks} consolidados, como PyTorch.}
\end{itemize}

\comentline{Sobre os critérios de escolha: refinar para deixar critérios mais objetivos, por exemplo, o que significa ''ser um LLM representativo''}
...
\comentline{Sobre a escolha do modelo: é importante listar outros candidatos, se possível adicionar uma tabela para mostrar em qual requisito os outros candidatos não atendem.}
...
\comentline{Por que a escolha dessas estratégias de poda, considerando que existem outras opções?}



\begin{itemize}
    \item \textcolor{red}{poda não estruturada: poda por magnitude}poda baseada em magnitude dos pesos \cite{Han2015}, que remove parâmetros
    ...
    \item \textcolor{red}{poda estruturada: poda de cabeças}poda estruturada \cite{Li2017}, que elimina unidades arquiteturais inteiras
