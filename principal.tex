...
\include{02_capitulo/fundamentacao_transformer}  % TEMPORARIO - so para visualizar - REMOVER depois
\include{03_capitulo/trabalhos_relacionados}
\include{04_capitulo/metodologia_nova}    % capítulo Metodologia (novo)
\include{04_capitulo/metodologia}         % capítulo Desenvolvimento (antigo, renomeado)
