...
% Comandos de marca{\c{c}}{\~a}o de revis{\~a}o (adicionados nesta revis{\~a}o)
\newcommand{\mantido}[1]{#1}  % preservado integralmente: sem marca{\c{c}}{\~a}o visual
\newcommand{\modificado}[1]{\textcolor{orange}{#1}}  % ajustes pontuais em texto do Enzo
...
\include{03_capitulo/trabalhos_relacionados}
\include{04_capitulo/metodologia}
\include{05_capitulo/resultados}
